    ...
    public JdbcBatchItemWriter<Match> writer(DataSource dataSource) {
        return new JdbcBatchItemWriterBuilder<Match>()
                ...
                .sql("INSERT INTO match (id, city, date, player_of_match, venue, team1, team2, toss_winner, toss_decision, match_winner, result, result_margin, umpire1, umpire2) "
                        ...
                        // + "ON DUPLICATE KEY UPDATE id = VALUES(id), city = VALUES(city), date = VALUES(date), player_of_match = VALUES(player_of_match), venue = VALUES(venue), "
                        // + "team1 = VALUES(team1), team2 = VALUES(team2), toss_winner = VALUES(toss_winner), toss_decision = VALUES(toss_decision), match_winner = VALUES(match_winner), "
                        // + "result = VALUES(result), result_margin = VALUES(result_margin), umpire1 = VALUES(umpire1), umpire2 = VALUES(umpire2)")
